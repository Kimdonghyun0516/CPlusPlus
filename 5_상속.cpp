...
int main()
{
	...
	if (0)
	{
		...
		{
		private:
			int data1; // 자신의 클래스에서만 접근 가능, 자식도 사용 불가
		protected:
	...
	if (1)
	{
		...
		CGradeEx b;
		b.SetGrade(120);
		cout << "CGrade->120 : " << b.GetGrade() << endl;

		b.SetGrade(90);
		cout << "CGrade->90 : " << b.GetGrade() << endl;

		b.SetGrade(-10);
		cout << "CGrade->-10 : " << b.GetGrade() << endl;

		//------------------------------------------------
		// 구형 클래스의 참조로 접근
		CGrade& ref = b;
		ref.SetGrade(120); // 에러체크가 되나 안되나?
		cout << "참조로 접근->120 : " << ref.GetGrade() << endl;
		
		// 신형 클래스의 참조로 접근
		CGradeEx& ref2 = b;
		ref2.SetGrade(120); // 에러체크가 되나 안되나?
